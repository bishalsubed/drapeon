        ...
        <header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-orange-800'>
            <div className="container mx-auto px-4 py-3">
                <div className='flex flex-wrap justify-between items-center'>
                    <Link to='/' className='text-2xl font-bold text-orange-400 items-center space-x-2 flex'>
                        Drapeon
                    </Link>
                    <nav className="flex flex-wrap items-center gap-4">
					 ...
					 ease-in-out'
                        ...
                        {isAdmin && (
                            <Link
                                className='bg-orange-700 hover:bg-orange-600 text-white px-3 py-1 rounded-md font-medium
