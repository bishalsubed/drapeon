            ...
            <div className='container mx-auto px-4'>
                ...
                <div className='relative'>
                    ...
                    <button
                        ...
                        className={`absolute top-1/2 -left-4 transform -translate-y-1/2 p-2 rounded-full transition-colors duration-300 ${isStartDisabled ? "bg-gray-400 cursor-not-allowed" : "bg-orange-600 hover:bg-orange-500"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`absolute top-1/2 -right-4 transform -translate-y-1/2 p-2 rounded-full transition-colors duration-300 ${isEndDisabled ? "bg-gray-400 cursor-not-allowed" : "bg-orange-600 hover:bg-orange-500"
                            }`}
                    >
